...
\item Influenza season spans Morbidity and Mortality Weekly Report (MMWR) weeks 40-20; Seasons 2006-Present (2010 - 2015)
...
\begin{itemize}
\item Do you need the Asymmetrical Gaussian component?\pause
\item Does this work?
\end{itemize}
...
% \frametitle{Does it work?}
% 
% Comparing MSE and WAIC for the models:
% 
% <<MSE_plot, echo=FALSE, fig.show='asis', fig.height=3.5, fig.width=7.5>>=
% resdf <- data.frame(MSE=c(mean((subset(cdat, model=="Common")$pred - subset(cdat, model=="Common")$y)^2),
%                           mean((subset(cdat, model=="Indep")$pred - subset(cdat, model=="Indep")$y)^2),
%                           mean((subset(cdat, model=="RegMnSd")$pred - subset(cdat, model=="RegMnSd")$y)^2)
% ))
% 
...
%   \hline
%  & Common & Indep & RegMnSd \\
%   \hline
% MSE & 837351.69 & 1565.73 & 70.76  \\
%   WAIC & 956884.13 & 1392.37 & 72.08 \\
%    \hline
% \end{tabular}
